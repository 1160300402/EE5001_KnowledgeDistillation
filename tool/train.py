...
import sys
sys.path.append('/content/drive/MyDrive/Colab Notebooks/pspnet1')
...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='./config/cityscapes/cityscapes_resnet18.yaml', help='config file')
    parser.add_argument('opts', help='see config/ade20k/ade20k_pspnet50.yaml for all options', default=None, nargs=argparse.REMAINDER)
